    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http.cors()
                ...
                .authorizeHttpRequests()
                    ...
                    .requestMatchers(new AntPathRequestMatcher("/**/actividad/**")).authenticated()
                    .requestMatchers(new AntPathRequestMatcher("/**/rol/**")).hasRole("ADMINISTRADOR")
                    .requestMatchers(new AntPathRequestMatcher("/**/usuario/**")).hasRole("ADMINISTRADOR")
